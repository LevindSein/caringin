...
<div class="d-sm-flex align-items-center justify-content-between mg-b-20 mg-lg-b-25 mg-xl-b-30">
    <div>
        ...
        <h4 class="mg-b-0 tx-spacing--1">Akumulasi Tagihan Listrik <span class="text-primary">{{$bulan}} (Terbaru)</span></h4>
    </div>
    <hr>
    <div class="text-center">
        <button type="button" data-toggle="modal" data-target="#myGenerate" title="Cetak Tagihan Listrik" class="btn btn-sm pd-x-15 btn-primary btn-uppercase mg-l-5"><i data-feather="printer"></i> Generate</button>
    </div>
</div>
@endsection

@section('content')
<input type="hidden" id="fasilitas" value="listrik" />
<table 
    id="tabel" 
...
<div
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form class="user" action="{{url('keuangan/laporan/tagihan/generate/listrik')}}" method="GET" target="_blank">
