...
<html lang="en">
    ...
    <head>
        <meta charset="utf-8">
        <title>Form Pengajuan Diskon Air Bersih | BP3C</title>
        ...
        <div style="page-break-after:always;">
            <div class="row">
                <table class="tg" style="undefined;table-layout: fixed; width: 1200px">
                    ...
                    <tr>
                        <td class="tg-5b4e" colspan="5"><br><span style="font-size:16px"><b><u>FORM PENGAJUAN DISKON AIR</u></b></span><br><br></td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td class="tg-spw2"></td>
                        <td class="tg-spw2">Hanya Bayar</td>
                        <td class="tg-spw2">: 
                        <input type="checkbox" id="air" name="hanyabayar" value="pemakaian">
                        <label for="air">Pemakaian</label>
                        <input type="checkbox" id="air" name="hanyabayar" value="beban">
                        <label for="air">Beban</label>
                        <input type="checkbox" id="air" name="hanyabayar" value="pemeliharaan">
                        <label for="air">Pemeliharaan</label>
                        <input type="checkbox" id="air" name="hanyabayar" value="airkotor">
                        <label for="air">Air Kotor</label>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td class="tg-spw2"></td>
                        <td class="tg-spw2"></td>
                        <td class="tg-spw2">&nbsp
                        <input type="checkbox" id="air" name="hanyabayar" value="charge">
                        <label for="air">Charge : ........................ % dari <b>Tagihan / Pemakaian</b></label>
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td class="tg-spw2" colspan="5"><br>Mengajukan permohonan diskon tarif air. Sehubungan dengan permintaan tersebut diatas kami bersedia dan sanggup memenuhi ketentuan - ketentuan / peraturan - peraturan umum bagi pelanggan.<br></td>
                    </tr>
                    <tr>
