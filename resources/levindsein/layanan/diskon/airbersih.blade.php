        ...
        <div style="page-break-after:always;">
            <div class="row">
                <table class="tg" style="undefined;table-layout: fixed; width: 1200px">
                    ...
                    <tr>
                        <td class="tg-5b4e" colspan="5"><span style="font-size:16px"><b><u>FORM PENGAJUAN DISKON AIR</u></b></span></td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td class="tg-spw4" colspan="5">Mengajukan permohonan diskon tarif air bersih. Sehubungan dengan permintaan tersebut diatas kami bersedia dan sanggup memenuhi ketentuan - ketentuan / peraturan - peraturan umum bagi pelanggan. Serta bersedia melampirkan <b><u>1 lembar fotokopi KTP</u></b> sebagai persyaratan pengajuan diskon</td>
                    </tr>
                    <tr>
                        <td class="tg-ex10" colspan="4"><textarea placeholder="Alasan : " style="height:75px;width:560px;"></textarea></td>
