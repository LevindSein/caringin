        ...
        <div style="page-break-after:always;">
            <div class="row">
                <table class="tg" style="undefined; table-layout: fixed; width: 1200px">
                    ...
                    <tr>
                        <td class="tg-5b4e" colspan="5"><br><span style="font-size:16px"><b><u>FORM PENGAJUAN DISKON LISTRIK</u></b></span><br><br></td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td class="tg-spw2" colspan="5"><br>Mengajukan permohonan diskon tarif listrik. Sehubungan dengan permintaan tersebut diatas kami bersedia dan sanggup memenuhi ketentuan - ketentuan / peraturan - peraturan umum bagi pelanggan.<br></td>
                    </tr>
                    <tr>
