...
<html lang="en">
    ...
    <head>
        <meta charset="utf-8">
        <title>Form Pengajuan Diskon Kebersihan | BP3C</title>
        ...
        <div style="page-break-after:always;">
            <div class="row">
                <table class="tg" style="undefined;table-layout: fixed; width: 1200px">
                    ...
                    <tr>
                        <td class="tg-5b4e" colspan="5"><br><span style="font-size:16px"><b><u>FORM PENGAJUAN DISKON KEBERSIHAN</u></b></span><br><br></td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td class="tg-spw2"></td>
                        <td class="tg-spw2">Tarif Lama</td>
                        <td class="tg-spw2">: Rp. {{number_format($d['tarif'])}} / Unit</td>
                    </tr>
                    <tr>
                        ...
                        <td class="tg-spw2">: Rp. {{number_format($d['tarif'] * $d['unit'])}}</td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td class="tg-spw2"></td>
                        <td class="tg-spw2">Tarif Baru</td>
                        <td class="tg-spw2">: ................................. / Unit</td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td class="tg-spw2" colspan="5"><br>Mengajukan permohonan diskon tarif kebersihan. Sehubungan dengan permintaan tersebut diatas kami bersedia dan sanggup memenuhi ketentuan - ketentuan / peraturan - peraturan umum bagi pelanggan.<br></td>
                    </tr>
                    <tr>
