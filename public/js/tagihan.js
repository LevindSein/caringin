$(document).ready(function(){
    ...
    $(document).on('click', '.totalairbersih', function(){
        ...
        $.ajax({       
			...
			success:function(data)
			{
                $('.titles').html(data.result.kode + " (Air Bersih)");
                if(data.result.totalbulan1 != 0){
                    $('#divBulan1').show();
                    $('#bulan1').html(data.result.bulan1);
                    $('#totalbulan1').html("RP. " + data.result.totalbulan1);
    ...
    $(document).on('click', '.totalkeamananipk', function(){
        ...
        $('#divBulan6').hide();
        $.ajax({       
			url: "/cari/keamananipk/" + id,
            cache:false,
			method:"GET",
			dataType:"json",
			success:function(data)
			{
                $('.titles').html(data.result.kode + " (Keamanan IPK)");
                if(data.result.totalbulan1 != 0){
                    $('#divBulan1').show();
                    $('#bulan1').html(data.result.bulan1);
                    $('#totalbulan1').html("RP. " + data.result.totalbulan1);
    ...
    $(document).on('click', '.totalkebersihan', function(){
        ...
        $('#divBulan6').hide();
        $.ajax({       
			url: "/cari/kebersihan/" + id,
            cache:false,
			method:"GET",
			dataType:"json",
			success:function(data)
			{
                $('.titles').html(data.result.kode + " (Kebersihan)");
                if(data.result.totalbulan1 != 0){
                    $('#divBulan1').show();
                    $('#bulan1').html(data.result.bulan1);
                    $('#totalbulan1').html("RP. " + data.result.totalbulan1);
    ...
    $(document).on('click', '.totalairkotor', function(){
        ...
        $('#divBulan6').hide();
        $.ajax({       
			url: "/cari/airkotor/" + id,
            cache:false,
			method:"GET",
			dataType:"json",
			success:function(data)
			{
                $('.titles').html(data.result.kode + " (Air Kotor)");
                if(data.result.totalbulan1 != 0){
                    $('#divBulan1').show();
                    $('#bulan1').html(data.result.bulan1);
                    $('#totalbulan1').html("RP. " + data.result.totalbulan1);
    ...
    $(document).on('click', '.totallain', function(){
        ...
        $.ajax({       
			...
			success:function(data)
			{
                $('.titles').html(data.result.kode + " (Lain - Lain)");
                if(data.result.totalbulan1 != 0){
                    $('#divBulan1').show();
                    $('#bulan1').html(data.result.bulan1);
                    $('#totalbulan1').html("RP. " + data.result.totalbulan1);
    ...
    $(document).on('click', '.totaltagihan', function(){
        ...
        $.ajax({       
			...
			success:function(data)
			{
                $('.titles').html(data.result.kode + " (Total Tagihan)");
                if(data.result.totalbulan1 != 0){
                    $('#divBulan1').show();
                    $('#bulan1').html(data.result.bulan1);
                    $('#totalbulan1').html("RP. " + data.result.totalbulan1);
