$(document).ready(function () {
    ...
    $(document).on('click', '.totalkeamananipk', function(){
        ...
        $.ajax({       
			...
			success:function(data)
			{
                $('.modal-title').html(data.result.kode + " (Keamanan IPK)");
                if(data.result.totalbulan1 != 0){
                    $('#divBulan1').show();
                    $('#bulan1').html(data.result.bulan1);
                    $('#totalbulan1').html("RP. " + data.result.totalbulan1);
    ...
    $(document).on('click', '.totalkebersihan', function(){
        ...
        $.ajax({       
			...
			success:function(data)
			{
                $('.modal-title').html(data.result.kode + " (Kebersihan)");
                if(data.result.totalbulan1 != 0){
                    $('#divBulan1').show();
                    $('#bulan1').html(data.result.bulan1);
                    $('#totalbulan1').html("RP. " + data.result.totalbulan1);
    ...
    $(document).on('click', '.totalairkotor', function(){
        ...
        $.ajax({       
			...
			success:function(data)
			{
                $('.modal-title').html(data.result.kode + " (Air Kotor)");
                if(data.result.totalbulan1 != 0){
                    $('#divBulan1').show();
                    $('#bulan1').html(data.result.bulan1);
                    $('#totalbulan1').html("RP. " + data.result.totalbulan1);
    ...
    $(document).on('click', '.totallain', function(){
        ...
        $.ajax({       
			...
			success:function(data)
			{
                $('.modal-title').html(data.result.kode + " (Lain - Lain)");
                if(data.result.totalbulan1 != 0){
                    $('#divBulan1').show();
                    $('#bulan1').html(data.result.bulan1);
                    $('#totalbulan1').html("RP. " + data.result.totalbulan1);
